...
const TABS = [
  { id: "guarantee", label: "Ազդագիր" },
  { id: "report", label: "Ներքին իրավական ակտեր" },
  { id: "requirements", label: "Կորպորատիվ կառավարման տարեկան հայտարարագրեր" },
  { id: "evaluation", label: "Հաշվետվություններ" },
  { id: "model", label: "Հաշվետու թողարկողի զեկույցներ" },
  { id: "terms", label: "Կառավարման մարմիններ " },
];
...
const SECTIONS = {
  ...
  report: [
    { id: "report", title: "Ներքին իրավական ակտեր", links: ["Ներքին իրավական ակտեր"] },
  ],
  evaluation: [
    { id: "report", title: "Ֆինանսական հաշվետվություններ", links: [
        "«Տելեկոմ Արմենիա» ԲԲԸ-ի 2026թ 1-ին եռամսյակի միջանկյալ ֆինանսական հաշվետվություն»",
        "«Տելեկոմ Արմենիա» ԲԲԸ-ի 2025թ տարեկան ֆինանսական հաշվետվություն",
        "«Տելեկոմ Արմենիա» ԲԲԸ-ի 2025թ 4-րդ եռամսյակի միջանկյալ ֆինանսական հաշվետվություն»",
        "«Տելեկոմ Արմենիա» ԲԲԸ-ի 2025թ 3-րդ եռամսյակի միջանկյալ ֆինանսական հաշվետվություն»",
        "«Տելեկոմ Արմենիա» ԲԲԸ-ի 2025թ 2-րդ եռամսյակի միջանկյալ ֆինանսական հաշվետվություն»",
        "«Տելեկոմ Արմենիա» ԲԲԸ-ի 2025թ 1-ին եռամսյակի միջանկյալ ֆինանսական հաշվետվություն»"
    ] }
  ],
};

export default function Bajnetirner() {
