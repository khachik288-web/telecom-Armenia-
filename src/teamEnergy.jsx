  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-8 py-8">
        ...
        <h1 className="text-2xl font-bold text-[#0b3a5b] mb-6">Team Energy</h1>
        ...
        <div className="flex items-start gap-6 mb-8">
          <div className="w-28 h-28 rounded-2xl bg-[#0b3a5b] flex flex-col items-center justify-center text-white relative shrink-0">
            <img src="https://www.telecomarmenia.am/images/team_apps/1/17116228874075.png" className="" />
          </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <h3 className="font-semibold text-slate-800 mb-1">TeamTV</h3>
          ...
          <div>
            <div className="w-full h-32 rounded-xl bg-teal-500 flex items-center px-4 mb-3">
              <span className="text-white text-2xl font-bold">TeamPay</span>
            </div>
            <h3 className="font-semibold text-slate-800 mb-1">TeamPay</h3>
            <p className="text-sm text-slate-500 mb-3">
              Էլեկտրոնային դրամապանակ ավելի քան 50 տեսակի վճարումների համար
              Հատուկ առաջարկեր և ակցիաներ
            </p>
